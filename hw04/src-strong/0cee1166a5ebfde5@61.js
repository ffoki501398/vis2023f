...
function _createSVG(d3,finalData)
{
  ...
  g.selectAll("circle")
    .on("mouseover", function(d) {
      d3.select(this).attr("fill", "#9BB700");
    })
    .on("mouseout", function(d) {
      d3.select(this).attr("fill", "#003E3E");
  });
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>認為藝術產業的碳排放量越高，則對台灣2050淨零排放政策了解越少</li>
    <li>XY軸呈負相關</li>
  </ul>
</h3>`
)}
